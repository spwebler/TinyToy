...
public partial class NewReport2 : System.Web.UI.Page
{
    ...
    private void GetData()
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM MarksS where RollNo= '" + Convert.ToInt32(TextBox1.Text) + "'", con);
        DataTable dt = new DataTable("table3");
        da.Fill(dt);

        ReportViewer1.ProcessingMode = ProcessingMode.Local;
        ReportViewer1.LocalReport.ReportPath = Server.MapPath("Marks3.rdlc");
