...
public partial class NewReport : System.Web.UI.Page
{
    ...
    private void GetData()
    {
        SqlConnection con = new SqlConnection(@"Data Source=HP\SAIFYNSQL;Initial Catalog=Storage;Persist Security Info=True;User ID=sa;Password=Shiza@arti;Pooling=False"); 
            ...
            SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM MarksN where RollNo= '" + Convert.ToInt32(TextBox1.Text) + "'", con);  
            DataTable dt = new DataTable("table1");  
            da.Fill(dt);  
             
            ReportViewer1.ProcessingMode = ProcessingMode.Local;  
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("Marks.rdlc");  
